...
Version  : 47.1
Release  : 85
URL      : https://download.gnome.org/sources/gnome-initial-setup/47/gnome-initial-setup-47.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/47/gnome-initial-setup-47.1.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-47.1
cd %{_builddir}/gnome-initial-setup-47.1
pushd ..
cp -a gnome-initial-setup-47.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728573796
