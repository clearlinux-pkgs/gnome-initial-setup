...
Version  : 41.2
Release  : 41
URL      : https://download.gnome.org/sources/gnome-initial-setup/41/gnome-initial-setup-41.2.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/41/gnome-initial-setup-41.2.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-41.2
cd %{_builddir}/gnome-initial-setup-41.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638528231
...
cp %{_builddir}/gnome-initial-setup-41.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-initial-setup/122c4f624b853f6b8f131f4f0545e5f675a87d1a
