...
Source0  : https://download.gnome.org/sources/gnome-initial-setup/40/gnome-initial-setup-40.0.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-40.0
cd %{_builddir}/gnome-initial-setup-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619113249
...
cp %{_builddir}/gnome-initial-setup-40.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-initial-setup/122c4f624b853f6b8f131f4f0545e5f675a87d1a
