...
Source0  : https://download.gnome.org/sources/gnome-initial-setup/42/gnome-initial-setup-42.0.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-42.0
cd %{_builddir}/gnome-initial-setup-42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647898233
...
cp %{_builddir}/gnome-initial-setup-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-initial-setup/4cc77b90af91e615a64ae04893fdffa7939db84c
