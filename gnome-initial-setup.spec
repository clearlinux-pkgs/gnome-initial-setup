...
Version  : 41.4
Release  : 42
URL      : https://download.gnome.org/sources/gnome-initial-setup/41/gnome-initial-setup-41.4.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/41/gnome-initial-setup-41.4.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-41.4
cd %{_builddir}/gnome-initial-setup-41.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644536121
...
cp %{_builddir}/gnome-initial-setup-41.4/COPYING %{buildroot}/usr/share/package-licenses/gnome-initial-setup/122c4f624b853f6b8f131f4f0545e5f675a87d1a
