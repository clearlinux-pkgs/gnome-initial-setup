...
Version  : 48.0
Release  : 88
URL      : https://download.gnome.org/sources/gnome-initial-setup/48/gnome-initial-setup-48.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/48/gnome-initial-setup-48.0.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-48.0
cd %{_builddir}/gnome-initial-setup-48.0
pushd ..
cp -a gnome-initial-setup-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742859930
