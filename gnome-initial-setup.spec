...
Source0  : https://download.gnome.org/sources/gnome-initial-setup/3.30/gnome-initial-setup-3.30.0.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-3.30.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1537653916
export AR=gcc-ar
