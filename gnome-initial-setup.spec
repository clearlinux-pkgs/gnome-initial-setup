...
Version  : 46.3
Release  : 81
URL      : https://download.gnome.org/sources/gnome-initial-setup/46/gnome-initial-setup-46.3.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/46/gnome-initial-setup-46.3.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-46.3
cd %{_builddir}/gnome-initial-setup-46.3
pushd ..
cp -a gnome-initial-setup-46.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719594800
