...
Source0  : https://download.gnome.org/sources/gnome-initial-setup/46/gnome-initial-setup-46.0.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-46.0
cd %{_builddir}/gnome-initial-setup-46.0
pushd ..
cp -a gnome-initial-setup-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710894010
