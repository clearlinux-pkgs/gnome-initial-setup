...
Version  : 3.36.1
Release  : 28
URL      : https://download.gnome.org/sources/gnome-initial-setup/3.36/gnome-initial-setup-3.36.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/3.36/gnome-initial-setup-3.36.1.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-3.36.1
cd %{_builddir}/gnome-initial-setup-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586208758
...
cp %{_builddir}/gnome-initial-setup-3.36.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-initial-setup/122c4f624b853f6b8f131f4f0545e5f675a87d1a
