...
Version  : 47.4
Release  : 87
URL      : https://download.gnome.org/sources/gnome-initial-setup/47/gnome-initial-setup-47.4.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/47/gnome-initial-setup-47.4.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-47.4
cd %{_builddir}/gnome-initial-setup-47.4
pushd ..
cp -a gnome-initial-setup-47.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738352436
