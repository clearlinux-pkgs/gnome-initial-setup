...
Version  : 40.4
Release  : 39
URL      : https://download.gnome.org/sources/gnome-initial-setup/40/gnome-initial-setup-40.4.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/40/gnome-initial-setup-40.4.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-40.4
cd %{_builddir}/gnome-initial-setup-40.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629124148
...
cp %{_builddir}/gnome-initial-setup-40.4/COPYING %{buildroot}/usr/share/package-licenses/gnome-initial-setup/122c4f624b853f6b8f131f4f0545e5f675a87d1a
