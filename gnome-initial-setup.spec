...
Version  : 43.1
Release  : 61
URL      : https://download.gnome.org/sources/gnome-initial-setup/43/gnome-initial-setup-43.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-initial-setup/43/gnome-initial-setup-43.1.tar.xz
...
%prep
%setup -q -n gnome-initial-setup-43.1
cd %{_builddir}/gnome-initial-setup-43.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666120956
